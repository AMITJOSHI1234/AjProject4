<%@page import="com.raystec.project4.controller.FacultyCtl"%>
...
<%@page import="com.raystec.project4.bean.SubjectBean"%>
<%@page import="com.raystec.project4.bean.CourseBean"%>
<%@page import="com.raystec.project4.bean.CollegeBean"%>
...
<body>
	<jsp:useBean id="bean" class="com.raystec.project4.bean.FacultyBean"
	...
	<form action="<%=ORSView.FACULTY_CTL%>" method="post">
		...
		<center>
			...
			<input type="hidden" name="modifiedby" value=<%=bean.getModifiedBy()%>>
			 <input type="hidden" name="createdDatetime" value=<%=DataUtility.getStringData(bean.getCreateDateTime())%>>
