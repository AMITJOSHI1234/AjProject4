<%@page import="com.raystec.project4.model.TimeTableModel"%>
<%@page import="com.raystec.project4.controller.TimeTableListCtl"%>
<%@page import="com.raystec.project4.util.HTMLUtility"%>
<%@page import="com.raystec.project4.bean.TimeTableBean"%>
...
<body >
<jsp:useBean id="bean" class="com.raystec.project4.bean.TimeTableBean" scope="request"></jsp:useBean>
