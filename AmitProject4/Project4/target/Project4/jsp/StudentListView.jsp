...
<body>
<jsp:useBean id="cbean" class="com.raystec.project4.bean.CollegeBean" scope="request" ></jsp:useBean>
<jsp:useBean id="bean" class="com.raystec.project4.bean.StudentBean" scope="request" ></jsp:useBean>
