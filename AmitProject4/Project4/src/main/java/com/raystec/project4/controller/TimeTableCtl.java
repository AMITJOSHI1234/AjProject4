...
//		String op = DataUtility.getString(request.getParameter("operation"));
		...
		System.out.println("Id in doget:"+id);
		...
		if (id > 0) {
			try {
				...
				System.out.println("Id in doget:"+bean.getId());
				System.out.println("Courseid in doget:"+bean.getCourseId());
				System.out.println("Name in doget:"+bean.getCourseName());
