...
<body>
<jsp:useBean id="bean" class="com.raystec.project4.bean.SubjectBean" scope="request"></jsp:useBean>
...
<center>
	<h1>
	<%System.out.println("ID on jsp page:"+bean.getId()); %>
...
<div>	
	...
	<input type="hidden" name="id" value="<%=bean.getId()%>">
 	...
 	<input type="hidden" name="createddatetime" value="<%=bean.getCreateDateTime()%>">
