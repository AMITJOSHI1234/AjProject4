<%@page import="com.raystec.project4.controller.MarksheetListCtl"%>
<%@page import="com.raystec.project4.util.HTMLUtility"%>
<%@page import="com.raystec.project4.bean.MarksheetBean"%>
...
<body>
    <jsp:useBean id="bean" class="com.raystec.project4.bean.MarksheetBean" scope="request"></jsp:useBean>
