<%@page import="com.raystec.project4.controller.FacultyListCtl"%>
<%@page import="com.raystec.project4.util.HTMLUtility"%>
<%@page import="com.raystec.project4.bean.FacultyBean"%>
...
<jsp:useBean id="bean" class="com.raystec.project4.bean.FacultyBean" scope="request"></jsp:useBean>
<jsp:useBean id="colbean" class="com.raystec.project4.bean.CollegeBean" scope="request"></jsp:useBean>
<jsp:useBean id="corbean" class="com.raystec.project4.bean.CourseBean" scope="request"></jsp:useBean>
